...
async def start(client, message):
        ...
        for file in files:
            ...
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/Yaarulanee")
                ],[
    ...
    if STREAM_MODE == True:
        ...
        button = [[
            ...
            InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/YaarlaNee")
        ]]
    msg = await client.send_cached_media(
        chat_id=message.from_user.id,
        file_id=file_id,
